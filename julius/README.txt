...
This directory contains the files necessary for HAL-E to listen for activation commands, e.g. "OKAY HAL-E." HAL-E uses Julius Speech Recognition software in order to always listen for the activation command. 
